    ...
    const handleSignUp = async () => {
        ...
        while (true) {
            ...
            if (!consent) {
                ...
                Alert.alert('Please provide consent to our terms and conditions');
                break;
            }
        ...
        if (isEmailValid && isPasswordValid && isCFPasswordValid && isPhoneNumberValid && isConsentGiven) {
            console.log('success');
            signUpEmailPass(profile, { pdpaConsent: consent }, success, unsuccess);
        } else {
            ...
            <View style={{ flex: 2, borderTopLeftRadius: 32, borderTopRightRadius: 32, backgroundColor: '#fffffa' }}>
                <View style={{ flex: 1, paddingVertical: '10%', paddingHorizontal: '5%' }}>
                    ...
                    <TextInput style={{ height: 50, borderRadius: 16, marginTop: '5%', backgroundColor: '#ffffff', borderWidth: 1, borderRadius: 16, borderTopLeftRadius: 16, borderTopRightRadius: 16,
                        ...
                        placeholder='Phone Number*' placeholderTextColor="rgba(0, 0, 0, 0.3)" underlineColor='transparent' activeUnderlineColor="transparent" cursorColor="gray"
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: '5%' }}>
                        ...
                        />
                        <Text style={{ marginLeft: 8 }}>I agree to the <Text style={{ color: '#0ABAB5' }}>Terms and Conditions</Text></Text>
                    </View>

                    <View style={{ height: 20, alignItems: 'flex-end', marginBottom: '8%' }}></View>
